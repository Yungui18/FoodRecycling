...
//    public static final String IP = "http://bmtssystem.com/api/api.php";
    public static final String IP = "http://bmtssystem.com/api/new_api.php";
...
//    public static final String OUTSIDE = "outside";
     ...
     * 搅拌电机异常 stir 状态 = 4
     */
    public static int TROUBLE_TYPE_STIR = 1;
    /**
     * 排料口未关闭
     */
    public static int TROUBLE_TYPE_OUTLET = 2;
    /**
     * 观察口未关闭
     */
    public static int TROUBLE_TYPE_OBSERVE = 3;
    /**
     * 电动门（投入口）异常
     */
    public static int TROUBLE_TYPE_INLET = 4;
    /**
     * 加热异常,温度太高
     */
    public static int TROUBLE_TYPE_HEATING_MAX = 110;
    /**
     * 加热异常,温度太低
     */
    public static int TROUBLE_TYPE_HEATING_MIN = 111;
    /**
     * 称重异常
     */
    public static int TROUBLE_TYPE_WEIGH = 6;
    /**
     * 湿度异常
     */
    public static int TROUBLE_TYPE_HUMIDITY = 7;
    /**
     * "风压异常,
     * 请确认过滤网"
     */
    public static int TROUBLE_TYPE_WIND_PRESSURE = 8;
    /**
     * 搅拌异常  stir 状态 = 5
     */
    public static int TROUBLE_TYPE_STIR_ERROR = 9;
